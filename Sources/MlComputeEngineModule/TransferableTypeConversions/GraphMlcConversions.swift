...
extension Graph: PlatformGraphTransformable {
    public typealias PlatformGraph = MLCGraph
    public typealias PlatformTensor = MLCTensor
 
    public func makePlatformGraph() throws -> GraphTransformProducts<PlatformGraph, PlatformTensor>
    {
