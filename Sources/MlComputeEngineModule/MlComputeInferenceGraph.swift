...
/// 
public final class MlComputeInferenceGraph:
    InferenceGraphable,
    ModelInspectable
{
    ...
    public func compile(device: DeviceType) throws {
    ...
    public func execute(inputs: [Tensor], batchSize: Int) async throws -> Tensor {
    ...
    public func retrieveOutput() -> Tensor {
        convert(from: outputTensor)
    }
        
    public func retrieveGraph() throws -> Graph {
        return graph
    }
