...
public struct AdditionModel: TestModel {
    public struct Constant {
        public static let dataType: DataType = .float32
        public static let inputFeatureChannels: Int = 3
        public static let outputFeatureChannels: Int = 3
        public static let inputs: [[[Float]]] = [
