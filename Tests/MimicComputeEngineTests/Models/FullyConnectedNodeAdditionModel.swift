...
struct FullyConnectedNodeAdditionModel: TestModel {
    struct Constant {
        static let inputs = [[[Float]]]([[[2, 2]]])
        static let weights = [[Float]]([[1, 0.5]])
        static let biases = [Float]([2])
        static let inputFeatureChannels = 2
        static let outputFeatureChannels = 1
